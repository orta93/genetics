...
@section('content')
    <div class="container my-12 flex flex-col md:flex-row gap-4">
        ...
        <div class="w-full md:w-2/6 flex flex-col gap-4 p-4 bg-gray-200 border">
            ...
            <div class="flex flex-col border border-blue-200 bg-white">
                <div class="font-bold my-2 p-2 border-b">{{ $gene['name'] }}</div>
                    ...
                    {{--@foreach($gene['items'] as $item)--}}
                        {{--<div class="bg-blue-500 text-center py-1 text-white text-xs">{{ $item }}</div>--}}
                    {{--@endforeach--}}
            </div>
            @endforeach
        </div>
