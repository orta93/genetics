...
@section('content')
    ...
    <div class="container flex flex-col gap-4 py-12">
        <div class="font-bold text-2xl">Cuando se trata de medicamentos, una talla no se adapta a todos</div>
        <div class="flex flex-col gap-2">
            <div class="">¿Alguna vez le han recetado un medicamento que tuvo efectos secundarios imprevistos o simplemente ningún beneficio en absoluto? Si es así, no estás solo. Las pruebas genéticas personalizadas de medicamentos, también conocidas como pruebas farmacogenómicas (PGx), pueden ayudar a su médico a determinar qué medicamentos y dosis son adecuados para usted.</div>
        </div>
    </div>

    @include('partials.image-container', [
        'title' => 'Aproximadamente el 99% de las personas tienen variaciones genéticas que pueden hacer que no puedan procesar ciertos medicamentos de la manera en que están destinados.',
        'title_size' => 'text-3xl',
